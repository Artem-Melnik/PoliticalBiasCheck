document.addEventListener("DOMContentLoaded", () => {
    ...
    function grabTextFromPage(url) {
        if (window.location.href.includes("://x.com")) {
            ...
            $('[data-testid="postText"], [data-testid="postThreadItem-by-nytimes.com"] > div:nth-child(2) > div > div');


            $('[data-testid="postThreadItem-by-nytimes.com"] > div:nth-child(2) > div > div');
            const tweetContainers = document.querySelectorAll('[data-testid="postText"]');
            const texts = [];
