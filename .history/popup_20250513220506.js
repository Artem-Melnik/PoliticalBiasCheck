        ...
        if (window.location.href.includes("://x.com")) {
            ...
            for (let i = 0; i < tweetContainers.length; i++) {
                ...
                for (let j = 0; j < spans.length; j++) {
                    const textContent = spans[j].textContent.trim();
                    if (textContent) {
            ...
            const texts = document.querySelectorAll('[data-testid="postText"], [data-testid="postThreadItem-by-nytimes.com"] > div:nth-child(2) > div > div')[0].textContent.trim();
            // const texts = document.querySelectorAll('[data-testid="postThreadItem-by-nytimes.com"] > div:nth-child(2) > div > div')[0].textContent.trim();

            // const tweetContainers = ('[data-testid="postText"]');
            // const texts = [];

            // for (let i = 0; i < tweetContainers.length; i++) {
            //     const spans = tweetContainers[i];

            //     const textContent = spans.textContent.trim();
            //     if (textContent) {
            //         texts.push(textContent);
            //     }
            // }
